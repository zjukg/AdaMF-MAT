...
class MultiAdvMixTrainer(object):
    ...
    def train_one_step(self, data):
        ...
        for _ in range(self.adv_num):
            ...
            for score in scores:
                ...
                loss += self.model.loss(p_score, score) * self.mu / self.adv_num
        loss.backward()
        self.optimizer.step()
        # training G
        ...
        for _ in range(self.adv_num):
            ...
            for score in scores:
                loss_g += self.model.loss(score, p_score) / self.adv_num
        loss_g.backward()
